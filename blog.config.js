...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://evanescent-cheetah-0eb.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '907a44d5fa418332b5c981c6f7415991,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '晴晴', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个自媒体博主  欢迎关注🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qinqinlife.com', // 网站地址
  ...
  CUSTOM_EXTERNAL_CSS: ['/css/custom-font.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
