    ...
    <>
      ...
      <div
        ...
        <div className='flex items-center'>
          ...
          <p className='logo line-clamp-1 overflow-ellipsis ml-2 font-extrabold text-2xl md:text-3xl text-gray-900 dark:text-white header-name whitespace-nowrap tracking-wide'>
            {siteConfig('TITLE')}
          </p>
        </div>
        <NavBar {...props} />
